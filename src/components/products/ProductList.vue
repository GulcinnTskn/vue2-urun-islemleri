                ...
                <div class="card-body">
                    ...
                    <table class="table table-hover table-striped table-bordered" v-if="getProducts.length > 0">
                        ...
                        <tr v-for="product in getProducts" :key="product">
                            ...
                            <td class="align-middle"> {{product.barcodeNum}} </td>
                            <td class="align-middle"> <barcode v-model="product.barcodeNum">  </barcode> </td>
                        </tr>
                        </tbody>
                    </table>
  ...
  components:{
    ...
    methods : {
       getCountClasses(count){
        return{
          'btn-danger text-white' : count == 0 || count == null || count == NaN,
